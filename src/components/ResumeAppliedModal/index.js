...
export default function ResumeAppliedModal({children , data, jobPost, onSubmitModal, onDelete, type, userInfo}) {
  ...
  const handleAddResumeApplied = async() => {
      const appliedResume = await addResumeApplied(resumeID, jobPostID, email);
