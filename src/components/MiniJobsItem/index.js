...
import styles from './MiniJobsItem.module.scss';
...
function MiniJobsItem({ data, children }) {
    ...
    return (
        <div className={cx('wrapper')} onClick={()=>{navigate(`/job-info/${data?._id}`)}}>
